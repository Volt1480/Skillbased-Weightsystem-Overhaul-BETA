...
-- Build 42 ONLY (SP & MP Safe)
--------------------------------------------

print("[WeightOverhaul] CraftWeightDynamic_B42 loaded")

------------------------------------------------
-- Tiered skill curves
------------------------------------------------

-- Heavy materials (max −45%)
...
local function SanityCheck()
    print("====== Weight Overhaul B42 Sanity Check ======")
