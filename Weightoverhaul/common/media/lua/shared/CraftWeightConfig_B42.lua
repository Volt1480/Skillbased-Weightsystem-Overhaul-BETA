...
CraftWeight.WOOD_ITEMS = {
    ...
    ["Base.FirewoodBundleLarge"] = true,   -- B42
    ...
    ["Base.WoodCrate"] = true,            -- B42
    ["Base.WoodBeam"] = true,             -- B42
    ["Base.LaminatedPlank"] = true,       -- B42
}
...
CraftWeight.METAL_ITEMS = {
    ...
    ["Base.MetalSheetSmall"] = true,
    ["Base.MetalSheet"] = true,
